...
class HikeAdapter extends RecyclerView.Adapter<HikeAdapter.ViewHolder>  {
     ...
     */
    @Override
    public HikeAdapter.ViewHolder onCreateViewHolder(
     ...
     */
    @Override
    public void onBindViewHolder(HikeAdapter.ViewHolder holder,
                                 int position) {
        // Get current Hike.
        Hike currentHike = mHikeData.get(position);

        // Populate the textviews with data.
        holder.bindTo(currentHike);
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            mHikeImage = itemView.findViewById(R.id.HikeImage);

            // Set the OnClickListener to the entire view.
            itemView.setOnClickListener(this);
        }

        void bindTo(Hike currentHike){
            // Populate the textviews with data.
            mTitleText.setText(currentHike.getTitle());
            mInfoText.setText(currentHike.getInfo());

            // Load the images into the ImageView using the Glide library.
            Glide.with(mContext).load(
                    currentHike.getImageResource()).into(mHikeImage);
        }
